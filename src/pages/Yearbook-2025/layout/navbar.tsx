...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-50 top-0 w-full flex justify-between items-center py-4 px-4 sm:py-6 sm:px-20  bg-opacity-100 backdrop-blur-3xl transition duration-500">
