...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-50 top-0 w-full flex justify-between items-center py-4 px-4 sm:py-6 sm:px-20 bg-black bg-opacity-90 backdrop-blur-md transition duration-500">
